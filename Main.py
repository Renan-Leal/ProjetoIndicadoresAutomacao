...
emails_df = pd.read_excel(r'C:\Users\Renan\Desktop\PROJETO01\Bases de Dados\Emails.xlsx')
lojas_df = pd.read_csv(r'C:\Users\Renan\Desktop\PROJETO01\Bases de Dados\Lojas.csv', sep=';', encoding='latin1')
vendas_df = pd.read_excel(r'C:\Users\Renan\Desktop\PROJETO01\Bases de Dados\Vendas.xlsx')
...
caminho_backup = r'C:\Users\Renan\Desktop\PROJETO01\Backup Arquivos Lojas'
